...
${OBJECTDIR}/GrafosDepositos.o: GrafosDepositos.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GrafosDepositos.o GrafosDepositos.cpp
...
${OBJECTDIR}/SimuladorArmazem.o: SimuladorArmazem.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SimuladorArmazem.o SimuladorArmazem.cpp
